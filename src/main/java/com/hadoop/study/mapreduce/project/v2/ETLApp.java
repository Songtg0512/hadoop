package com.hadoop.study.mapreduce.project.v2;

import com.hadoop.study.mapreduce.project.utils.GetPageId;
...
public class ETLApp {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Path outputPath = new Path("/etlData/input");
        ...
        FileInputFormat.setInputPaths(job, new Path("/trackinfo_20130721.data"));
        FileOutputFormat.setOutputPath(job, new Path("/etlData/input"));
